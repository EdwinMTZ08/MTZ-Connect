...
<body>
  ...
  <div class="menu-redes" id="menuRedes">
    <a href="https://instagram.com/tu-usuario" target="_blank" aria-label="Instagram"><i class="fab fa-instagram"></i></a>
    <a href="https://facebook.com/tu-usuario" target="_blank" aria-label="Facebook"><i class="fab fa-facebook-f"></i></a>
    <a href="https://wa.me/52TUNUMERO" target="_blank" aria-label="WhatsApp"><i class="fab fa-whatsapp"></i></a>
    <a href="https://tiktok.com/@tu-usuario" target="_blank" aria-label="TikTok"><i class="fab fa-tiktok"></i></a>
  </div>
